(function () {
    ...
    privateNoteButton.setAttribute("aria-label", "Nota Privadaを開く");
    privateNoteButton.innerHTML = `<span class="private-note-launcher-icon" aria-hidden="true"><i></i><i></i><i></i></span><span>NOTA</span>`;
